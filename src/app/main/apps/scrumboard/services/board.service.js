(function ()
{
    ...
    function BoardService($q, api)
    {
         ...
         * @returns {*}
         */
        function getPromptData(boardId)
        {
            // Create a new deferred object
            var deferred = $q.defer();

            api.prompts.prompt.get({id: boardId},
